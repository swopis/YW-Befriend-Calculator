				...
				<table cellpadding="10px">
					...
					<tr>
						...
						<td class="advanced" hidden>
							...
							<br />
							<input id="food_%I_5" type="radio" name="food_%I" onclick="calculate()" />
							<label for="food_%I_5">Forbidden Fruit</label>
							<br />
							<br />
							...
							<br />
							<label for="blaster_%I">Blaster Level</label>
							<br />
							<input type="range" id="blaster_%I" oninput="calculate()" value="0"/>
			</td>
`;
